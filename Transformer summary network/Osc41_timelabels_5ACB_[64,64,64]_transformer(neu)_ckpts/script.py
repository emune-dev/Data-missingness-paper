...
class SetTransformer(tf.keras.Model):
    ...
    def __init__(
        ...
        num_inducing_points=16,   # Default: 32
        num_seeds=1,
        **kwargs
    ):
...
summary_net = SetTransformer(input_dim=2, attention_settings=dict(num_heads=4, key_dim=64), dense_settings=dict(units=128, activation='relu'))
...
trainer = ParameterEstimationTrainer(
    ...
    checkpoint_path = './Osc41_timelabels_5ACB_[64,64,64]_transformer(neu)_ckpts',
    max_to_keep=300,
    skip_checks=True
)
