...
def batch_simulator(prior_samples, n_obs):   
    ...
    Unlike usual Augment 0/1, sample number of missing time steps for entire batch!
    """    
...
trainer = ParameterEstimationTrainer(
    ...
    checkpoint_path = './Oscillation41_augment01(batch)_5ACB_[64,64,64]_LSTM(128)_ckpts',
    max_to_keep=300,
    skip_checks=True
)
