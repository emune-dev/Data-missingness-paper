...
def batch_simulator(prior_samples, n_obs):   
    """
    Simulate multiple oscillation model datasets with missing values and time labels
    """    
...
trainer = ParameterEstimationTrainer(
    ...
    checkpoint_path = './Oscillation41_timelabels_5ACB_[64,64,64]_LSTM(128)_ckpts',
    max_to_keep=300,
    skip_checks=True
)
